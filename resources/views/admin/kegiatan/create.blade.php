        ...
        <div class="p-6 rounded-2xl bg-white border border-slate-200/50 shadow-sm space-y-5">
            ...
            <div class="grid sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <textarea name="alamat_lengkap" id="alamat_lengkap" rows="2" class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-emerald-400/50 text-sm resize-none" placeholder="Alamat lengkap lokasi kegiatan" readonly>{{ old('alamat_lengkap') }}</textarea>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" step="any" name="latitude" id="latitude" value="{{ old('latitude') }}" class="w-full px-4 py-3 rounded-xl border border-slate-200 bg-slate-50 text-slate-500 text-sm focus:outline-none" placeholder="-6.9175" readonly>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-slate-700 mb-1.5">Longitude</label>
                        <input type="number" step="any" name="longitude" id="longitude" value="{{ old('longitude') }}" class="w-full px-4 py-3 rounded-xl border border-slate-200 bg-slate-50 text-slate-500 text-sm focus:outline-none" placeholder="107.6191" readonly>
                    </div>
                </div>
            </div>
