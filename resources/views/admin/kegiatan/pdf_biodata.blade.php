    ...
    @foreach($peserta as $index => $p)
        ...
        <div class="{{ !$loop->last ? 'page-break' : '' }}">
            ...
            <div class="header text-center">
                <!-- If logo exists in public/images, you can use it. Since we don't know, we use a placeholder text or leave it empty if no logo -->
                <!-- <img src="{{ public_path('images/logo.png') }}" class="logo" alt="Logo UIN"> -->
                <br>
